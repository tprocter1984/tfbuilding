...
class Hjemmesider_news_widget2 extends WP_Widget {

    /**
     * Register widget with WordPress.
     */
    function __construct() {
        parent::__construct('Hjemmesider_news_widget2',
...
function register_Hjemmesider_news_widget2() {
    register_widget('Hjemmesider_news_widget2');
}
add_action('widgets_init', 'register_Hjemmesider_news_widget2');
